...
export const asyncRouterMap = [
  ...
  },
  {
    ...
    children: [
      {
        path: 'list',
        component: () => import('@/views/cabinet/list'),
        name: 'listMcabine',
        meta: {
          perms: ['GET /admin/maincabine/list', 'POST /admin/maincabine/delete'],
          title: '主柜管理',
          noCache: true
        }
      },
      {
        path: 'sub',
        component: () => import('@/views/cabinet/sub'),
        name: 'listSCabinet',
        meta: {
          perms: ['GET /admin/subcabinet/list', 'POST /admin/subcabinet/create', 'POST /admin/subcabinet/update', 'POST /admin/subcabinet/delete'],
          title: '子柜管理',
          noCache: true
        }
      },
      {
        path: 'standard',
        component: () => import('@/views/cabinet/standard'),
        name: 'listStandard',
        meta: {
          perms: ['GET /admin/standard/list', 'POST /admin/standard/create', 'POST /admin/standard/update', 'POST /admin/standard/delete'],
          title: '规格管理',
          noCache: true
        }
      },
      {
        path: 'urecord',
        component: () => import('@/views/cabinet/urecord'),
        name: 'listUsageRecord',
        meta: {
          perms: ['GET /admin/usagerecord/list'],
          title: '使用记录',
          noCache: true
        }
      },
      {
        path: 'cashord',
        component: () => import('@/views/cabinet/cashord'),
        name: 'listcashord',
        meta: {
          perms: ['GET /admin/cashord/list', 'GET /admin/cashord/cashpostal'],
          title: '提现管理',
          noCache: true
        }
      },
      {
        path: 'profitstati',
        component: () => import('@/views/cabinet/profitstati'),
        name: 'statProfitstati',
        meta: {
          perms: ['GET /admin/systat/profitstati'],
          title: '资金流水统计',
          noCache: true
        }
      }
