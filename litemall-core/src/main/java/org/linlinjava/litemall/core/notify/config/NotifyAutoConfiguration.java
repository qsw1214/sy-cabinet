...
public class NotifyAutoConfiguration {
	...
	public NotifyService notifyService() {
		...
		NotifyProperties.Aliyunsms aliConfig = properties.getAlisms();
		if (aliConfig.isEnable()) {
			notifyService.setAliappid(aliConfig.getAppid());
			notifyService.setAliappkey(aliConfig.getAppkey());
			notifyService.setAlisign(aliConfig.getSign());
		}
