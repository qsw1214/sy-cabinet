...
public class WxAuthController {
	 ...
	 */
	@PostMapping("getuser")
	public Object getuser(@LoginUser Integer userId, HttpServletRequest request) {
	...
	public Object registerCaptcha(@RequestBody String body) {
		...
		// 阿里云短信平台
		String Aliparams = "{number:\"" + code + "\"}";
		notifyService.AliSms(phoneNumber, NotifyType.CAPTCHA, Aliparams);
	 ...
	 * @param request
	 *            请求对象
	 * @return 登录结果 成功则 { errno: 0, errmsg: '成功', data: { token: xxx,
	 *         tokenExpire: xxx, userInfo: xxx } } 失败则 { errno: XXX, errmsg: XXX
	 *         }
	 */
	...
	public Object bindPhone(@RequestBody String body) {
		...
		WxMaPhoneNumberInfo phoneNumberInfo = this.wxService.getUserService().getPhoneNoInfo(sessionKey, encryptedData,
				iv);
